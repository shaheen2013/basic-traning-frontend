  ...
  return (
    <section className="container flex flex-col gap-8 lg:gap-24 py-12 lg:py-32">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-16">
        <div className="flex flex-col gap-8 lg:gap-12 group py-8 lg:py-16 hover:shadow-sm transition-shadow rounded-sm duration-50 px-4">
        ...
        <div className="flex flex-col gap-8 lg:gap-12 border-t border-slate-500 py-8 lg:py-16 group hover:shadow-sm transition-shadow rounded-sm duration-50 px-4">
